...
public class EmployeeValidator {
     ...
     * @param passwordCheckFlag パスワードの入力チェックするかどうか(実施する:true 実施しない:false)
     * @return エラーのリスト
     */
     ...
     * @return エラーメッセージ
     */
    private static String validateCode(EmployeeService service, String code, Boolean codeDuolicateCheckFlag) {
     ...
     * @param passwordCheckFlag パスワードの入力チェックをするかどうか(実施する:true 実施しない:false)
     * @return エラーメッセージ
     */
